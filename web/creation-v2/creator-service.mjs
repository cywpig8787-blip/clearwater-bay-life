import {newCharacter} from './character-data.mjs?v=cyw51-r8';
import {validateAttributes} from './attribute-engine.mjs?v=cyw51-r8';
import {categories,rules,proficiencyGroups} from './catalog.mjs?v=cyw51-r8';
