import {attributes,categories,proficiencyGroups,rules} from './catalog.mjs?v=cyw51-r10';
import {attributeTotal,clampAttribute,validateAttributes} from './attribute-engine.mjs?v=cyw51-r10';
